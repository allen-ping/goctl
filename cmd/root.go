...
import (
	...
	"github.com/allen-ping/goctl/v2/api"
	"github.com/allen-ping/goctl/v2/bug"
	"github.com/allen-ping/goctl/v2/config"
	"github.com/allen-ping/goctl/v2/docker"
	"github.com/allen-ping/goctl/v2/env"
	"github.com/allen-ping/goctl/v2/gateway"
	"github.com/allen-ping/goctl/v2/internal/cobrax"
	"github.com/allen-ping/goctl/v2/internal/version"
	"github.com/allen-ping/goctl/v2/kube"
	"github.com/allen-ping/goctl/v2/migrate"
	"github.com/allen-ping/goctl/v2/model"
	"github.com/allen-ping/goctl/v2/quickstart"
	"github.com/allen-ping/goctl/v2/rpc"
	"github.com/allen-ping/goctl/v2/tpl"
	"github.com/allen-ping/goctl/v2/upgrade"
