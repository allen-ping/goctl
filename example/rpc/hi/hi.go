...
import (
	...
	"github.com/allen-ping/goctl/v2/example/rpc/hi/internal/config"
	eventServer "github.com/allen-ping/goctl/v2/example/rpc/hi/internal/server/event"
	greetServer "github.com/allen-ping/goctl/v2/example/rpc/hi/internal/server/greet"
